...
export class WebgisComponent implements AfterViewInit, OnDestroy {
  ...
  async ngAfterViewInit(): Promise<void> {
    ...
    if (!mapElement) {
      ...
      this.message = 'Map container not found.';
      return;
    }
    ...
    try {
      ...
      this.L = ((leafletModule as any).default ?? leafletModule) as typeof Leaflet;

      if (!this.L || typeof this.L.tileLayer !== 'function') {
        console.error('Leaflet did not load correctly:', this.L);
        this.message = 'Leaflet failed to load.';
        return;
      }
      ...
      this.message = 'Leaflet failed to import.';
    }
  }
  ...
  private initMap(): void {
    ...
    this.message = 'Map loaded successfully.';
  }
  ...
  private clearHighlight(): void {
    if (this.highlightedLayer && this.map) {
